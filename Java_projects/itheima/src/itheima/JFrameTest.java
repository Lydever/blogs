...
public class JFrameTest {
	...
	public class JFrameTest extends JFrame{
		...
		JLabel interestLabel = new JLabel("ÐËÈ¤");
		JCheckBox badmintonCheck = new JCheckBox("ÓðÃ«Çò");
		JCheckBox tableTtennisCheck = new JCheckBox("Æ¹ÅÒÇò");
		JCheckBox singCheck = new JCheckBox("³ª¸è");
		
		JLabel genderLabel = new JLabel("ÐÔ±ð");
		JRadioButton maleRadioButton = new JRadioButton("ÄÐ");
		JRadioButton femalRadioButton = new JRadioButton("Å®");
