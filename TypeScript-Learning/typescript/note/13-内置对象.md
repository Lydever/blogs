...
## ECMAScript 的内置对象[§](https://ts.xcatliu.com/basics/built-in-objects.html#ecmascript-的内置对象)
...
## DOM 和 BOM 的内置对象[§](https://ts.xcatliu.com/basics/built-in-objects.html#dom-和-bom-的内置对象)
...
## 用 TypeScript 写 Node.js[§](https://ts.xcatliu.com/basics/built-in-objects.html#用-typescript-写-node.js)
...
## 参考[§](https://ts.xcatliu.com/basics/built-in-objects.html#参考)
