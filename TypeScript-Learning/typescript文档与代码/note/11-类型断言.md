...
### 将任何一个类型断言为 `any`[§](https://ts.xcatliu.com/basics/type-assertion.html#将任何一个类型断言为-any)
...
### 将 `any` 断言为一个具体的类型[§](https://ts.xcatliu.com/basics/type-assertion.html#将-any-断言为一个具体的类型)
...
## 类型断言的限制[§](https://ts.xcatliu.com/basics/type-assertion.html#类型断言的限制)
