...
$row=mysqli_fetch_array($ShowDetailResult);
?>
...
<center>
    <table width="300">
        ...
        <tr>
            <td width="81" rowspan="8"><img width='80' height='120' img src="../uploads/<?php echo $CouNo.'.jpg'?>" border="0" ></td>
    ...
    $GetTotalResult=mysqli_query($conn,$GetTotal_SQL);
    if(mysqli_num_rows($GetTotalResult)<5){
        ?>
