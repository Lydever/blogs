...
<body>
	<div>
    	...
    	<tr>
    		<td class="t0">工号：</td>
    		<td>
    			<input type="text" placeholder="请输入工号" name="tno" id="tno" class="t1" required="required">
    			<span style="color: rgba(176,0,0);font-size: 24px;">*</span>
    		</td>
    	</tr>
    	<tr>
			...
			if(isset($_POST['zhuce']))
			{
				...
				if($password1==$password2)
				{
					...
					else
					{
						...
						{
							echo"<script>alert('该工号已存在！')</script>";
							exit();
						}
						else
						{
							mysqli_query($link,"insert into t values ('$username','$tno','$name','$sex',NULL,NULL,'$dept',NULL,NULL)");
